 ...
 */
final class Version20220131105537 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles_source_pages CHANGE source_alias source_alias enum(\'shikimori\', \'yummyanime\', \'anivisual\'), CHANGE type type enum(\'anime\', \'manga\', \'ranobe\')');
    }
