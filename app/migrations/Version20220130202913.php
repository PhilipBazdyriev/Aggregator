 ...
 */
final class Version20220130202913 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles CHANGE year year SMALLINT DEFAULT NULL, CHANGE age_rating age_rating enum(\'G\', \'PG\', \'PG-13\', \'PG-17+\', \'R+\'), CHANGE type type enum(\'anime\', \'manga\', \'ranobe\'), CHANGE status status enum(\'released\', \'anons\', \'ongoing\', \'latest\')');
